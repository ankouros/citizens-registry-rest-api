...
Στο παρόν αποθετήριο οι τιμές του `terraform.tfvars` είναι **σκόπιμα ανωνυμοποιημένες**.
Πριν την εκτέλεση, ο χρήστης οφείλει να αντικαταστήσει τα placeholders με
πραγματικές τιμές ή να χρησιμοποιήσει το αρχείο `terraform.tfvars.example`
ως οδηγό συμπλήρωσης.
